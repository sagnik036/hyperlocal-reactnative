...
export default function Wallet({navigation}) {
  ...
  return (
    ...
    {apidata?(<Text style={{
        ...
        right: -160,
        top: -35,
    }}>ID: {apidata.data.wallet_id}</Text>):(<Text style={{
        textAlign: "center",
        color: "white",
        fontWeight: "400",
        fontSize: 12,
    ...
    {apidata?(<Text style= {{
        ...
        INR {apidata.data.last_payment}</Text>):(<Text style= {{
        textAlign: "center",
        color: "white",
        fontWeight: "700",
        fontSize: 24,
    ...
    {apidata?(<Text style= {{
        ...
        INR {apidata.data.total_payment}</Text>):(<Text style= {{
        textAlign: "center",
        color: "Black",
        fontWeight: "700",
        top: 15,
